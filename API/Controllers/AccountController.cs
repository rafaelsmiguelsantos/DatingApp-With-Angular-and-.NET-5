...
namespace API.Controllers
{
    public class AccountController : BaseApiController
    {
        ...
        {
            if (await UserExists(registerDto.Username)) return BadRequest("Nome de Usuário já está sendo usado");
        ...
        public async Task<ActionResult<UserDto>> Login(LoginDto loginDto)
        {
            ...
            if (user == null) return Unauthorized("Usuárioincorreto. Tente Novamente.");
